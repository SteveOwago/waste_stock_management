@extends('layouts.app', ['page' => 'Edit Deposit', 'pageSlug' => 'deposits', 'section' => 'transactions'])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('transactions.update', $transaction) }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">Edit this Deposit</h6>
                            <div class="pl-lg-4">
