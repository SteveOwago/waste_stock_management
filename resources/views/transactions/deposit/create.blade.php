@extends('layouts.app', ['page' => 'New Deposit', 'pageSlug' => 'deposits', 'section' => 'transactions'])
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">New Deposit</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('transactions.type', ['type' => 'deposit']) }}" class="btn btn-sm btn-primary">Back to List</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('transactions.store') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">Deposit Information</h6>
                            <div class="pl-lg-4">
