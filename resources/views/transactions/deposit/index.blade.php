@extends('layouts.app', ['page' => 'Deposit', 'pageSlug' => 'deposit', 'section' => 'transactions'])
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('transactions.create', ['type' => 'deposit']) }}" class="btn btn-sm btn-primary">Register Deposit</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($transactions as $transaction)
                                    <tr>
                                        ...
                                        <td class="td-actions text-right">
                                            ...
                                            @else
                                                <a href="{{ route('transactions.edit', $transaction) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Edit Deposit">
